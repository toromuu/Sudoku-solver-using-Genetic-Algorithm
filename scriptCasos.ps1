$argv1Fichero=@("Caso-A1.txt","Caso-A2.txt","Caso-A3.txt","Caso-A4.txt","Caso-A5.txt","Caso-A6.txt")
$argv5Selector=@(1,2)
$argv2PopSize=@(100,150)
$argv3PCross=@(0.8,0.85,0.9,0.95)
$argv4PMut=@(0.05,0.075,0.1,0.125)
